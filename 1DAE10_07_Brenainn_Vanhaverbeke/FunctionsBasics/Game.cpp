...
void TestGetFloatRand()
{
	...
	int onBounds{};
	std::cout << "In [0, 3.14159] " << GetFloatRand(0.0f, g_Pi, 2) << std::endl;
	std::cout << "In [-2, 5] " << GetFloatRand(-2.0f, 5.0f, 2) << std::endl;
	std::cout << std::endl;
}
...
void TestCalcCosSin()
{
	std::cout << "Testing CalcCosSin()\n";
	std::cout << std::setw(10) << "Radians" << std::setw(10) << "Cos" << std::setw(10) << "Sin" << std::endl;
	for (int i{ 0 }; i < 10; i++)
	{
		float radians{ GetFloatRand(0, 2 * g_Pi, 2) };
		float cos{};
		float sin{};
		CalcCosSin(radians, cos, sin);
		std::cout << std::setw(10) << std::setprecision(3) << radians;
		std::cout << std::setw(10) << std::setprecision(2) << cos;
		std::cout << std::setw(10) << std::setprecision(2) << sin << std::endl;
	}
	std::cout << std::endl;
}
...
{
	cosResult = cosf(radians);
	sinResult = sinf(radians);
}
